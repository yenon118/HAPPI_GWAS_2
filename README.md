...
The HAPPI_GWAS_2 is a command line tool that can be ran on any Linux computing systems. The arguments of the tool are shown as below:

```
usage: HAPPI_GWAS_2 [-h] -p PROJECT_NAME -w WORKFLOW_PATH -i INPUT_FOLDER -o OUTPUT_FOLDER -v VCF_FILE -g GFF_FILE [--gff_category GFF_CATEGORY] [--gff_key GFF_KEY] 
